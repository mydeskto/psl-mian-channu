...
export const news: NewsItem[] = [
  ...
  { id: 'n-2', title: 'Meet the captains leading the charge', summary: 'Four captains, four distinct styles, and one shared ambition: lift the PSL 4 trophy.', date: '27 Aug 2025', imageUrl: '/logo.png', category: 'Feature' },
