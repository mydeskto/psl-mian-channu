...
export const commentary: CommentaryEntry[] = [
  { id: 'c-1', matchId: 'm-3', over: '12.4', ball: '04', text: 'FOUR! Faraz leans into the cover drive and beats the sweeper.', timestamp: '19:42' },
  { id: 'c-2', matchId: 'm-3', over: '12.3', ball: '03', text: 'A dot ball to start the over. Tight line from Hassan.', timestamp: '19:41' },
