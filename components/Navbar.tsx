...
export function Navbar() {
  ...
  return <header className="sticky top-0 z-50 border-b border-white/10 bg-navy/95 text-white backdrop-blur">
    <div className="section-shell flex h-[76px] items-center justify-between">
      <Link href="/" className="flex items-center gap-3"><img src="/logo.png" alt="PSL Mian Channu" className="h-12 w-12 rounded-full object-cover" /><span className="hidden font-display text-xl font-bold tracking-tight sm:block">PSL <span className="text-leaf">MIAN CHANNU</span></span></Link>
